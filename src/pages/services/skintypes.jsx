        ...
        <>
            ...
            <section id = "services">
                    <div class="content-wrapper">
                        <h1 class="title services-animated">About Skin Type Solutions
                        </h1>
                        
                        <div class="main-content">
                            <div class="image-gallery">
                                <img class = "first-img" src = "/assets/images/images/stsimg.webp"/>
                                <img src = "/assets/images/images/stsfollowupinfo/skntyp.co_ShopOwn.png"/>
                                <img src = "/assets/images/images/stsfollowupinfo/skntyp.co_OwnSkinQuiz.png"/>
            ...
            Before you start your new <strong>Skin Type Solutions</strong> skin care routine, you need to determine your skin type. Did you know that 80% of people don’t know their skin type? Chances are you’ve been treating your skin improperly. Thanks to the revolutionary skin typing system created by Dr. Leslie Baumann, you can discover your true skin type, whether that’s Type 1: Dry, Sensitive, Pigmented and Tight, or Type 12: Oily, Resistant, Non-Pigmented and Wrinkle Prone. For each of the 16 unique skin types
            <br/><br/>
            <a href = "https://skntyp.co/OwnSkinQuiz"><button type = "button" class = "btn btn-outline-light">SkinTypes Quiz</button></a>
