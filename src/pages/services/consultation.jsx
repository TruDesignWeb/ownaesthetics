...
export default function Consultation() {
    return (
        <>
            ...
            <div id = "services">
                <div class = "container">
                    {/* <h1 class = "title servces-animated">LifeViz® Infinity Pro Consultation</h1> */}
                    <div class = "row">
                        <div class = "col-md-auto services-text service-boxes animated">
                            <p>Our philosophy is that every person is unique, valuable, and beautiful in their own skin, in their
                                ...
                                plans and personal skin analysis consultations.<br></br><br></br>
                                ...
                                pores, and redness. This camera enables a unique visualization of facial shapes from any angle.<br></br><br></br>
                                ...
                                <br></br><br></br>We want you to feel empowered and encouraged, believing that aging is a good and natural
                                process.<br></br><br></br>
